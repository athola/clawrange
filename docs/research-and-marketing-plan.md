...
- **r/SideProject post format**: `[Launch] Name — one-liner`
  ...
  hardest part), 3-5 specific features, and ending question. [^sideproject]
...
- **Triangulation and citations** are the discipline that makes
  research output trustworthy.

## Implementation plan

### Commit 1: multi-source research orchestrator
...
### Commit 2: persist research sessions
...
### Commit 3: personal brand and content ideas
- Seed a `personal-brand` project (owner: athola) tracking
  AI-agents, plugins, MSP tooling.
- Add `content_idea_generator` to the GENERATORS registry. It pulls
...
### Commit 4: comment-draft generator
- Add `comment_draft_generator` to GENERATORS. It drafts a useful,
...
### Commit 5: research and marketing posture
...
### Commit 6: surface new capabilities
